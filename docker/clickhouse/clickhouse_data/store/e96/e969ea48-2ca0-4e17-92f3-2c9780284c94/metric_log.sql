ATTACH TABLE _ UUID '69b89b4b-2b89-4ba8-ada6-8ed68ed2df5a'
(
    ...
    `CurrentMetric_DiskPlainRewritableAzureUniqueFileNamesCount` Int64 COMMENT 'Number of unique file name entries in the \'plain_rewritable\' in-memory map for AzureObjectStorage.',
    ...
    `CurrentMetric_DiskPlainRewritableLocalUniqueFileNamesCount` Int64 COMMENT 'Number of unique file name entries in the \'plain_rewritable\' in-memory map for LocalObjectStorage.',
    ...
    `CurrentMetric_DiskPlainRewritableS3UniqueFileNamesCount` Int64 COMMENT 'Number of unique file name entries in the \'plain_rewritable\' in-memory map for S3ObjectStorage.',
